        ...
        https.get(apisjson_url, res => {
          ...
          res.on('end', () => {
            ...
            //else{
              ...
              var sql = "UPDATE apisjson SET  slug=" + connection.escape(apisjson_slug) + ",path=" + connection.escape(save_apisjson_path) + ", valid=1, name = " + connection.escape(apisjson_name) + ",description = " + connection.escape(apisjson_description) + ",image = " + connection.escape(apisjson_image) + ",pulled='" + created + "' WHERE url = " + connection.escape(apisjson_url);
              connection.query(sql, function (error, results, fields) {  
